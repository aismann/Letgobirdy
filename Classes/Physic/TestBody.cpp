...
void TestBody::DrawSolidPolygon(const b2Vec2* vertices, int32 vertexCount, const b2Color& color){
  ...
  DrawPrimitives::drawSolidPoly(points, vertexCount, Color4F(217.0/255.0f, 208.0/255.0f , 208.0/255.0f, 100.0f));
  //delete points;
}

/// Draw a circle.
void TestBody::DrawCircle(const b2Vec2& center, float32 radius, const b2Color& color){
  DrawPrimitives::setDrawColor4B(217.0/255.0f, 208.0/255.0f , 208.0/255.0f, 100.0f);
...
void TestBody::DrawSolidCircle(const b2Vec2& center, float32 radius, const b2Vec2& axis, const b2Color& color){
  DrawPrimitives::setDrawColor4B(217/255.0f, 208.0/255.0f , 208.0/255.0f, 100.0f);
...
void TestBody::DrawPoint(const b2Vec2& p, float32 size, const b2Color& color) {}
